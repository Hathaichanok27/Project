                            ...
                            <tr style="text-align:center">
                                ...
                                <td>
                                    <form action="{{ route('roommediasingles.destroy',$roommediasingle->id) }}" method="POST">
                                        <a href="{{ route('roommediasingles.show',$roommediasingle->id) }}" class="btn btn-info" role="button" aria-pressed="true">แสดง</a>
                                        <a href="{{ route('roommediasingles.edit',$roommediasingle->id) }}" class="btn btn-primary" role="button" aria-pressed="true">แก้ไข</a>
                                        @csrf
                                        @method('DELETE')
