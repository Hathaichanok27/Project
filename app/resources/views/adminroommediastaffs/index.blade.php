                ...
                <div class="col-md-4 col-md-offset-2">
                    <div class="panel border-grey">
                        <div class="panel-body text-center">
                            ...
                            <a href="{{ route('queuelistmediagroups.index') }}"" class="btn bg-danger-400">รายการการจอง <i class="fas fa-search"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="panel border-grey">
                        <div class="panel-body text-center">
                            ...
                            <a href="{{ route('queuelistmediasingles.index') }}"" class="btn bg-success-400">รายการการจอง <i class="fas fa-search"></i></a>
                        </div>
                    </div>
                </div>
            </div>
