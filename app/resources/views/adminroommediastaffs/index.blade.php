...
@section('content')
	<div class="page-container">
		<div class="container">
            ...
            <h3 class="text-light heading-divided"><i class="fas fa-map-marker-alt"></i> โซนชั้น 6 <small>6<sup>th</sup> floor</small> (สำหรับเจ้าหน้าที่)</h3>
                <div class="col-md-4 col-md-offset-2">
                    <div class="panel border-grey">
                        <div class="panel-body text-center">
                            ...
                            <a href="{{ route('queuelistmediagroups.index') }}"" class="btn bg-warning-400">รายการการจอง <i class="fas fa-search"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="panel border-grey">
                        <div class="panel-body text-center">
                            ...
                            <a href="{{ route('queuelistmediasingles.index') }}"" class="btn bg-primary-400">รายการการจอง <i class="fas fa-search"></i></a>
                        </div>
                    </div>
                </div>
            </div>
