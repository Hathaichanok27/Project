                        ...
                        <div class="panel panel-body border-grey">
                            <div class="media">
                                ...
                                <div class="media-right media-middle">
                                    <span class="label label-lg label-<?php echo $room->room_status == 'ไม่เปิดใช้งาน'?'danger':''?><?php echo $room->room_status == '1'?'success':''?><?php echo $room->room_status == '2'?'warning':''?>"> {{ $room->room_status }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
