...
@section('content')
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					<li><a href="http://roombooking.lib.buu.ac.th/">หน้าแรก</a></li>
				</ul>
  ...
  <div class="datatable-header" style="padding:15px;">
      <div id="qTable_filter" class="dataTables_filter"><label><span>Filter:</span> <input type="search" class="ng-pristine ng-untouched ng-valid ng-empty" placeholder="Type to filter..." aria-controls="qTable" ng-model="searchFilterWaiting"></label></div>
  </div>
