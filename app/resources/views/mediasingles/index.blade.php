		...
		<div class="container">
			<div class="page-title">
                ...
                <div class="heading-elements">
                    <a href="{{ route('confirmmediasingles.index') }}" class="btn btn-lg btn-labeled btn-labeled-right bg-danger heading-btn">จองคิวใช้บริการ <b><i class="fa fa-calendar"></i></b></a>
                </div>
            </div>
