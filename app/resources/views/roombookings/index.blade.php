                ...
                <div class="col-md-4 col-md-offset-2">
                    <div class="panel border-grey">
                        <div class="panel-body text-center">
                            ...
                            <a href="{{ route('roommeetings.index') }}" class="btn bg-success-400">ไปที่ <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="panel border-grey">
                        <div class="panel-body text-center">
                            ...
                            <a href="{{ route('roommedias.index') }}" class="btn bg-danger-400">ไปที่ <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
